function initPayPalButton() {
  ...
  var orderDescription = 'Social Media Hub Website';
  if (orderDescription === '') {
    ...
    onApprove: function (data, actions) {
      return actions.order.capture().then(async function (orderData) {
         ...
         switch (orderData.purchase_units[0]?.amount.value) {
           case '15.00':
             page_needed = "./html/thanks_social_15.html"
             product = "Social Media Hub Website"
             break;
           case '40.00':
             page_needed = "./html/thanks_social_40.html"
             product = "Social Media Hub Website with form"
             break;
           default:
